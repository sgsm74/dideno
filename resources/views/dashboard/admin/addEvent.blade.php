            ...
            <form class="form-horizontal" method="post" action="{{ route('admin.events.store') }}" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" class="form-control" id="location" name="location" placeholder="مکان رویداد" value="{{ old('location') }}">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <input type="text" name="cost" id="cost" class="form-control" placeholder="هزینه رویداد به تومان" value="{{ old('cost') }}">
                  </div>

                  <label for="capacity" class="col-md-2 control-label">ظرفیت</label>
                  <div class="col-md-1">
                    <input type="text" name="capacity" id="capacity" class="form-control" placeholder="ظرفیت رویداد" value="{{ old('capacity') }}">
                  </div>

                </div>
                <div class="form-group">
                  <div class="col-md-12">
                    <textarea class="form-control" id="describtion" name="describtion" rows="10" cols="80" >{{ old('describtion') }}</textarea>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-5">
